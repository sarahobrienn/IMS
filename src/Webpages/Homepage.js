...
function HomePage() {
  return (
    <div className="homepage">
      ...
      </div> {/* This div closes the container div */}

      <div className="container"> {/* This is a new container div */}
        <h2>
          <p>
      ...
      </div> {/* This div closes the second container div */}

    </div> // This div closes the homepage div
  );
}
